import { InvalidArgsSpecError, RequiredArgsError, UnexpectedArgsError, FailedFlagValidationError, NonExistentFlagsError, } from './errors';
...
export async function validate(parse) {
    ...
    async function validateFlags() {
        ...
        if (failed.length > 0)
            throw new FailedFlagValidationError({ parse, failed });
    }
