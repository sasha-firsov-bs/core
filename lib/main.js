...
async function run(argv, options) {
    ...
    if (options && ((typeof options === 'string' && options.startsWith('file://')) || options instanceof node_url_2.URL)) {
...
function getTsConfigPath(dir, type) {
    return type === 'cjs' ? (0, path_1.join)(dir, '..', 'tsconfig.json') : (0, path_1.join)((0, path_1.dirname)((0, node_url_1.fileURLToPath)(dir)), '..', 'tsconfig.json');
}
/**
